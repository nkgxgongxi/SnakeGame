...
while running:
    ...
    if badtimer == 0:
        ...
        badtimer = BADTIME_MAX - (badtimer1*2)
        if badtimer1 >= 35:
            badtimer1 = 35
        else:
            badtimer1 += 5
    ...
    for event in pygame.event.get():
        ...
        # pygame.KEYDOWN means user pressing on the key
        ...
        # 9 - Move player
        # keys[0,2] controls vertical move distance
        if keys[0]:
            # each move is 5 units 
            playerpos[1] -= 5
        elif keys[2]:
            playerpos[1] += 5
        # keys[1,3] controls horizontal move distance
        if keys[1]:
            playerpos[0] -= 5
        elif keys[3]:
            playerpos[0] += 5
